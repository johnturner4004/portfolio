...
export default function About() {
  return (
    <div className='about'>
      ...
      <p>This site was created using React, Redux, JavaScript, and HTML for the front end, SCSS, CSS, and JSS for most of the styling with Material-UI on the pages I use to manage the page contents. While some of these technologies are not necessary to use together, I wanted to demonstrate that I can be very flexible with what I work with and easily shift from one language/framework to another. All graphics are done using SCSS and CSS only; no images were used. I also made a clone of this <a href="https://vue-portfolio-johnturner4004.vercel.app/">site</a> using Vue instead of React.</p>
    </div>
  )
}