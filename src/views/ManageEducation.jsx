...
export default function ManageEducation() {
  ...
  const handleChange = (e) => {
    ...
    } else if (e.target.name === 'education_description') {
      setChange({
        ...change,
              ...
              <li key={school._id} className="manage-education__li">
                <Box className="manage-education__box" mx="auto">
                  ...
                  <FormControl sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                    <TextField
                      name="start_date"
                      defaultValue={school.start_date}
                      label="Start Date"
                      variant="filled"
                      sx={{
                        mr: 1, mt: 1, mb: 1, width: '100%',
                  ...
                  <FormControl fullWidth sx={{ m: 1, mx: 'auto' }}>
                    <InputLabel variant="filled" shrink>Academic Achievement and/or Description (separate points with &lsquo;;&rsquo;)</InputLabel>
                    <FilledInput
                      multiline
