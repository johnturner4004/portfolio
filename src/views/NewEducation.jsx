    ...
    <div className="new-education">
      ...
      <Box component='form' sx={{ width: 600, mx: 'auto' }}>
        <FormControl sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
          <TextField name="school" label='School' variant="filled" onChange={handleChange} sx={{ mr: 1, mt: 1, mb: 1, width: '100%' }} />
          <TextField name="major" label='Major' variant="filled" onChange={handleChange} sx={{ ml: 1, mt: 1, mb: 1, width: '100%' }} />
        </FormControl>
        <FormControl sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
        ...
        <FormControl fullWidth sx={{ m: 1, mx: 'auto' }}>
          <InputLabel variant='filled'>Academic Achievement and/or Description (separate points with ';')</InputLabel>
          <FilledInput
            multiline
